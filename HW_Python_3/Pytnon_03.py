...
usd_byn_rate = 2.46
# 20. Сделать if в котором будет условие: если mult_int больше comp_item, то вывести в консоль (“Переменная mult_int
# больше”, comp_item)
...
div_int = int_item / 2
# 22. Сделать if в котором будет условие: если div_int меньше comp_item, то вывести в консоль (“Переменная div_int
# меньше”, comp_item)
...
item_1 = int_item + 10
# 24. Сделать if в котором будет условие: если item_1 меньше comp_item, то вывести в консоль (“Переменная item_1
# меньше”, comp_item), иначе, вывести в консоль (“Переменная item_1 больше или равна”, comp_item)
if item_1 < comp_item:
    print('Переменная', item_1, 'меньше', comp_item)
else:
    print('Переменная item_1 больше или равна', comp_item)
# 25. Сделать if в котором будет условие: если item_2, то вывести в консоль (“Переменная item_2 = ”, item_2), иначе,
# вывести в консоль (“Переменная item_2 = ”, item_3)
if item_2:
    print('Переменная item_2 =', item_2)
else:
    print('Переменная item_2 =', item_3)
# 26. Сделать if в котором будет условие: если item_3, то вывести в консоль (“Переменная item_3 = ”, item_2), иначе,
# вывести в консоль (“Переменная item_3 = ”, item_3)
if item_3:
    print('Переменная item_3 =', item_2)
else:
    print('Переменная item_3 =', item_3)
# 27. Сделать if в котором будет условие: если item_5, то вывести в консоль (“Переменная item_5 = ”, item_5), иначе,
# вывести в консоль (“Переменная item_5 = ”, item_4)
if item_5:
    print('Переменная item_5 =', item_5)
else:
    print('Переменная item_5 =', item_4)
# 28. Сделать if в котором будет условие: если item_4, то вывести в консоль (“Переменная item_4 = ”, item_5), иначе,
...
# 31.4 Сделать if в котором будет условие: если target_currency равен ‘eur’, то в теле этого if в значении переменной
# currency_result высчитать сколько долларов получится при target_currency_amount и usd_eur_rate. Результат вывести
# в консоль (target_currency_amount, eur_item, “=”, currency_result, usd_item)
# 31.5 Сделать elif в котором будет условие: если target_currency равен ‘uah’, то в теле этого if в значении переменной
# currency_result высчитать сколько долларов получится при target_currency_amount и usd_uah_rate. Результат вывести
...
while currency_result == int:
    ...
    if target_currency == 'eur':
        target_currency_amount = float(input("Введите количество евро, которые хотите конвертировать в usd:"))
        currency_result = target_currency_amount * usd_eur_rate
        print(target_currency_amount, eur_item, '=', currency_result, usd_item)
    elif target_currency == 'uah':
        target_currency_amount = float(input("Введите количество гривен, которые хотите конвертировать в usd:"))
        currency_result = target_currency_amount * usd_uah_rate
        print(target_currency_amount, usd_item, '=', currency_result, uah_item)
    elif target_currency == 'chf':
        target_currency_amount = float(input("Введите количество франков, которые хотите конвертировать в usd:"))
        currency_result = target_currency_amount * usd_chf_rate
        print(target_currency_amount,usd_item, '=', currency_result, chf_item)
    elif target_currency == 'rub':
        target_currency_amount = float(input("Введите количество российских рублей, которые хотите конвертировать в usd:"))
        currency_result = target_currency_amount * usd_rub_rate
        print(target_currency_amount, usd_item, '=', currency_result, rub_item)
    elif target_currency == 'byn':
        target_currency_amount = float(input("Введите количество белорусских рублей, которые хотите конвертировать в usd:"))
        currency_result = target_currency_amount * usd_byn_rate
        print(target_currency_amount, usd_item, '=', currency_result, byn_item)
    else:
        target_currency != list_currency
        print("Неизвестная валюта,попробуйте ещё раз вести валюту, которую хотите конвертировать в usd")
else:
    print('Поздравляем вы успешно произвели конвертацию')